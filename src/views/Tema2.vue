...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    figure
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/w4h4vsglRe4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    .row.container.justify-content-center.align-items-center
      ...
      .row 
        .col-lg-11.bloque-cajon-color
          .cajon.color-primario.p-4
            ...
            .col-lg-7        
              a.anexo(:href="obtenerLink('/downloads/anexo_2_Caracteristicas_centro_datos.pdf')" target="_blank")
                .anexo__icono
