  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Aprendiz, la siguiente actividad le permitirá reconocer la adquisición de conocimientos sobre los #[emdata center], normativas y buenas prácticas aplicadas. 
        p ¡Buena suerte!
